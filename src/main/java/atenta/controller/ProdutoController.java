...
public class ProdutoController extends AbstractController{
    ...
    public String lista(ModelMap model){
        List<Produto> produtos = produtoDao.findAllNotConsumed();
    ...
    public @ResponseBody Produto xml(@PathVariable("id") Integer id) throws NotFoundException{
    ...
    public String novo(@PathVariable("id_compra") Integer id_compra, ModelMap model) throws NotFoundException{
